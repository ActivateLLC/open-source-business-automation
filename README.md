...
### Main Dashboard
![Dashboard Overview](https://github.com/user-attachments/assets/41298896-341f-4e3b-8be7-bc16289fa919)

The main dashboard provides quick actions, real-time metrics, and natural language command input for generating charts and insights on demand.

### Natural Language Query
![Natural Language Query](https://github.com/user-attachments/assets/4b24cb5e-4465-415b-85d3-d08217eedc30)

Ask questions in plain English and get instant visualizations - no need to navigate menus or configure complex reports.

### AI-Powered Insights
![AI-Powered Insights](https://github.com/user-attachments/assets/351a8b3c-db1d-4d0c-accb-26f31dad1b51)

Get intelligent business insights generated by AI, with contextual recommendations and actionable next steps.
